...
class DisetujuiPelangganPage extends StatefulWidget {
  const DisetujuiPelangganPage({super.key});

  @override
  State<DisetujuiPelangganPage> createState() => _DisetujuiPelangganPageState();
}

class _DisetujuiPelangganPageState extends State<DisetujuiPelangganPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text("Disetujui Pelanggan",
