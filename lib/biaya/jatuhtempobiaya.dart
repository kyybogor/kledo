...
class JatuhTempoBiaya extends StatefulWidget {
  const JatuhTempoBiaya({super.key});

  @override
  State<JatuhTempoBiaya> createState() => _JatuhTempoBiayaState();
}

class _JatuhTempoBiayaState extends State<JatuhTempoBiaya> {
...
Future<void> fetchInvoices() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        invoices = data
            .where((item) => item["status"] == "Jatuh Tempo")
