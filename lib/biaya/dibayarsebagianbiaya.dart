...
class DibayarSebagianBiaya extends StatefulWidget {
  const DibayarSebagianBiaya({super.key});

  @override
  State<DibayarSebagianBiaya> createState() => _DibayarSebagianBiayaState();
}

class _DibayarSebagianBiayaState extends State<DibayarSebagianBiaya> {
...
Future<void> fetchInvoices() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        invoices = data
            .where((item) => item["status"] == "Belum Sebagian")
