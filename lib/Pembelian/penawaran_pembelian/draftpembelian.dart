...
class DraftPembelianPage extends StatefulWidget {
  const DraftPembelianPage({super.key});

  @override
  State<DraftPembelianPage> createState() => _DraftPembelianPageState();
}

class _DraftPembelianPageState extends State<DraftPembelianPage> {
