...
class DitolakPelangganPembelianPage extends StatefulWidget {
  const DitolakPelangganPembelianPage({super.key});

  @override
  State<DitolakPelangganPembelianPage> createState() => _DitolakPelangganPembelianPageState();
}

class _DitolakPelangganPembelianPageState extends State<DitolakPelangganPembelianPage> {
