...
class _KontakScreenState extends State<KontakScreen> {
  ...
  Future<void> fetchContacts() async {
    final response = await http.get(Uri.parse("http://192.168.1.5/connect/JSON/kontak.php"));
  ...
  Widget build(BuildContext context) {
    List<dynamic> filtered = allContacts
        .where((item) => item['nama'].toLowerCase().contains(searchQuery.toLowerCase()))
        .toList()
                          ...
                          ListTile(
                            leading: CircleAvatar(
                              backgroundColor: Colors.primaries[
                                  item['nama'].codeUnitAt(0) % Colors.primaries.length],
                              child: Text(
                                item['nama'].toString().substring(0, 2).toUpperCase(),
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            child: Text(data['nama'][0].toUpperCase(), style: const TextStyle(fontSize: 24, color: Colors.white)),
                          ),
                          const SizedBox(height: 16),
                          ...
                          Align(
                            ...
                            child: TextButton(onPressed: () {}, child: const Text("Lihat Detail")),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Row(
                    children: [
                      Expanded(child: _hutangCard("Anda Hutang", "0", Colors.orange)),
                      const SizedBox(width: 12),
                      Expanded(child: _hutangCard("Mereka Hutang", "0", Colors.redAccent)),
                    ],
                  ),
                ],
              ),
      ...
      children: tabs.map((tab) {
        ...
        return Container(
          decoration: BoxDecoration(
            ...
            boxShadow: isActive
                ? [BoxShadow(color: Colors.blue.withOpacity(0.4), blurRadius: 6, offset: Offset(0, 3))]
                : [],
          ),
